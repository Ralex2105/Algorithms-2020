    ...
    protected fun doIteratorTest() {
        ...
        for (iteration in 1..100) {
            ...
            for (iteration in 1..300) {
                val controlSet = mutableSetOf<String>()
                for (i in 1..15) {
                    val string = newRandom.nextString("dscrvee344221", 1, 15)
                    controlSet.add(string)
                }
                println("Control set: $controlSet")
                val openAddressingSet = create<String>(random.nextInt(6) + 4)
                ...
                for (iteration in 1..100) {
                    val controlSet = mutableSetOf<String>()
                    for (i in 1..15) {
                        val string = newRandom.nextString("sdcdscs344212", 1, 15)
                        controlSet.add(string)
                    }
                    println("Control set: $controlSet")
                    val openAddressingSet = create<String>(random.nextInt(6) + 4)
    ...
    protected fun doIteratorRemoveTest() {
        ...
        for (iteration in 1..100) {
            ...
            for (iteration in 1..150) {
                val controlSet = mutableSetOf<String>()
                val removeIndex = newRandom.nextInt(9) + 1
                var toRemove = ""
                for (i in 1..15) {
                    val string = newRandom.nextString("aqwdewvcwc22432", 1, 15)
                    controlSet.add(string)
                    if (i == removeIndex) {
                        toRemove = string
                    }
